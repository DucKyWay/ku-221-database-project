...
CREATE TABLE `PENALTY_ENTRY` (
  ...
  `snapshot_penalty_entry_type` enum('CONSTANT','BASED_ON_SALARY') DEFAULT 'BASED_ON_SALARY',
  `snapshot_penalty_entry_method` varchar(255) DEFAULT NULL,
  `snapshot_penalty_entry_fixed_amount` decimal(15,2) DEFAULT NULL,
  `penalty_duration` decimal(10,2) DEFAULT NULL
